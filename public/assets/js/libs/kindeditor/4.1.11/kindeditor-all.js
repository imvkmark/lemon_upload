...
KindEditor.basePath = lemon.url_js+'/libs/kindeditor/4.1.11/';
KindEditor.iConfig = {};
KindEditor.iConfig.full = [
    'source', '|', 'undo', 'redo', '|', 'preview', 'print', 'template', 'code', 'cut', 'copy', 'paste',
    'plainpaste', 'wordpaste', '|', 'justifyleft', 'justifycenter', 'justifyright',
    'justifyfull', 'insertorderedlist', 'insertunorderedlist', 'indent', 'outdent', 'subscript',
    'superscript', 'clearhtml', 'quickformat', 'selectall', '|', 'fullscreen', '/',
...
KindEditor.iConfig.dft = [
    'bold','italic','underline', 'strikethrough','removeformat', '|',
    'justifyleft', 'justifycenter', 'justifyright','formatblock','insertorderedlist', 'insertunorderedlist','|','image', 'multiimage'
];
KindEditor.iConfig.simple = [
    'bold','italic','underline', 'strikethrough','removeformat', '|',
    ...
    'link', 'unlink','emoticons','table','image', 'multiimage','flash','|', 'pagebreak', 'source', 'about'
];
	return KindEditor;
});