...
;(function (factory) {
	...
	else if ( typeof define === "function" )  // AMD/CMD/Sea.js
	{
		...
		{
			var cmModePath = "libs/codemirror/5.1.2/mode/";
			var cmAddonPath = "libs/codemirror/5.1.2/addon/";

			var codeMirrorModules = [
				"jquery", "marked", "prettify",
				"katex", "raphael", "underscore", "flowchart", "jquery.flowchart", "sequence-diagram",
				"libs/codemirror/5.1.2/lib/codemirror",
				'codemirror.inline-attachment', // inline-attachment
				'global', // inline-attachment
				cmModePath + "css/css",
	...
	if ( typeof define == "function" && define.amd ) {
		$ = arguments[0];
		var marked = arguments[1];
		var prettify = arguments[2];
		var katex = arguments[3];
		window.Raphael = arguments[4];
		var _ = arguments[5];
		var flowchart = arguments[6];
		var CodeMirror = arguments[9];
		var inlineAttachment = arguments[10];
		var lemon = arguments[11];
	}
	...
	editormd.prototype = editormd.fn = {
		...
		init : function (id, options) {
			...
			if ( typeof define === "function" && define.amd ) {
				...
				if ( settings.searchReplace && !settings.readOnly ) {
					editormd.loadCSS(settings.path + "addon/dialog/dialog");
					editormd.loadCSS(settings.path + "addon/search/matchesonscrollbar");
				}
			}
		...
		setInineAttach : function () {
			inlineAttachment.editors.input.attach(this.cm, {
				uploadUrl:this.settings.imageUploadURL
			});
