define(function (require, exports, module) {
	...
	function fullAvatarEditor() {
		...
		var file = lemon.url_js + '/libs/full-avatar-editor/2.3/fullAvatarEditor.swf';		//flash文件的路径
		var version = "10.1.0";						//播放该flash所需的最低版本
		var expressInstall = lemon.url_js + '/libs/full-avatar-editor/2.3/expressInstall.swf';			//expressInstall.swf的路径
	...
	module.exports = fullAvatarEditor;
});