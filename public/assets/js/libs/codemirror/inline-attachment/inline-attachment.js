...
(function (document, window) {
	...
	inlineAttachment.util = {
		 ...
		 */
		insertTextAtCursor : function (cm, text) {
	...
	inlineAttachment.prototype.onPaste = function (e) {
		...
		console.log(typeof clipboardData);
...
(function () {
	...
	inlineAttachment.editors.input = {
		Editor : function (cm) {
			return {
				...
				insertValue : function (val) {
					inlineAttachment.util.insertTextAtCursor(cm, val);
				},
		...
		attach : function (cm, options) {
			options = options || {};

			var editor = new inlineAttachment.editors.input.Editor(cm);
